    ...
    public function data(bool $licensingGateApplied = false): array
    {
        ...
        return [
            ...
            'macro' => [
                ...
                'analyses' => [
                    ['provider' => 'Gemini (demo)', 'model' => 'illustrative', 'status' => 'demo', 'gold_bias' => 'neutral', 'usd_strength' => 'neutral', 'risk_level' => 'medium', 'confidence' => 54, 'summary' => 'Illustrative Gemini assessment for layout testing only.', 'supporting_factors' => ['Softer-yield scenario'], 'opposing_factors' => ['Firm-dollar scenario'], 'risk_factors' => [], 'historical_assessment' => ['sample_quality' => 'insufficient', 'alignment_trend' => 'unclear', 'regime_fit' => 'unclear', 'summary' => 'Illustrative history only.', 'caveats' => ['Small demo sample.']], 'citation_ids' => []],
                    ['provider' => 'Groq GPT-OSS (demo)', 'model' => 'illustrative', 'status' => 'demo', 'gold_bias' => 'neutral', 'usd_strength' => 'neutral', 'risk_level' => 'medium', 'confidence' => 50, 'summary' => 'Illustrative GPT-OSS assessment for layout testing only.', 'supporting_factors' => ['Defensive demand scenario'], 'opposing_factors' => ['Dollar resilience scenario'], 'risk_factors' => [], 'historical_assessment' => ['sample_quality' => 'insufficient', 'alignment_trend' => 'unclear', 'regime_fit' => 'unclear', 'summary' => 'Illustrative history only.', 'caveats' => ['Small demo sample.']], 'citation_ids' => []],
                ],
                'historical_assessment' => ['sample_quality' => 'insufficient', 'alignment_trend' => 'unclear', 'regime_fit' => 'unclear', 'agreement' => 'agree', 'summary' => 'Illustrative historical evidence is intentionally insufficient.', 'caveats' => ['Illustrative demo data.']],
                'provider_status' => [],
