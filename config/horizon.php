...
return [
    ...
    'history' => [
        ...
        'minimum_samples' => (int) env('BIAS_HISTORY_MINIMUM_SAMPLES', 20),
        'established_samples' => (int) env('BIAS_HISTORY_ESTABLISHED_SAMPLES', 50),
        'retention_days' => (int) env('BIAS_HISTORY_RETENTION_DAYS', 730),
        'max_chart_points' => (int) env('BIAS_HISTORY_MAX_CHART_POINTS', 360),
        'outcome_horizons' => [
            '5m' => [30],
            '15m' => [60],
            '1h' => [240],
            ...
            '1w' => [40320],
            '1mo' => [129600],
            'overall' => [240, 1440, 10080],
        ],
        'outcome_candle_timeframes' => [
            '5m' => '5m',
            '15m' => '15m',
            '1h' => '1h',
            '4h' => '4h',
